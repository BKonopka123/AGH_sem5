...
SELECT c.czytelnik_id, COUNT(DISTINCT k.ksiazka_id) AS ilosc_wypozyczonych_ksiazek
FROM czytelnik c
...
SELECT k.ksiazka_id, COUNT(DISTINCT c.czytelnik_id) AS ilosc_czytelnikow
FROM ksiazki k
...
HAVING COUNT(DISTINCT c.czytelnik_id) > 1;
